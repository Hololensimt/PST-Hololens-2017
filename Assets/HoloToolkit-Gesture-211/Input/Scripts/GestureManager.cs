...
namespace Academy.HoloToolkit.Unity
{
    public class GestureManager : Singleton<GestureManager>
    {
        ...
        private GameObject currentMoving = null;
        ...
        private void ManipulationRecognizer_ManipulationStarted(ManipulationStartedEventArgs obj)
        {
            if (HandsManager.Instance.FocusedGameObject != null)
            {
                ...
                currentMoving = InteractibleManager.Instance.FocusedGameObject;
                wasKinematic = InteractibleManager.Instance.FocusedGameObject.transform.root.GetComponent<Rigidbody>().isKinematic;
                currentMoving.transform.root.GetComponent<Rigidbody>().isKinematic = true;
        ...
        {
            if (!wasKinematic)
                currentMoving.transform.root.GetComponent<Rigidbody>().isKinematic = false;
